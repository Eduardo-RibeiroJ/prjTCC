...
<!-- Masthead -->
    ...
    <section class="masthead" id="home" style="background: url(imagem/90463.jpg); background-size: cover;">
        <div class="container">
                            ...
                            <div class="card my-2">
                                ...
                                <div class="card-body">
                                    <div class="card-text">
                                        ...
                                        <?php $tel2 = $candidato->getTel2() == "" ? '' : 'Celular: '.$candidato->getTel2(); echo $tel2 ?>
                                    </div>
                                </div>
                            </div>
